...
func (x *EventPermission) GetPermission() string {
	if x != nil {
		return x.Permission
	}
	return ""
...
func (x *EventPermission) GetActorId() int64 {
	if x != nil {
		return x.ActorId
	}
	return 0
...
var file_permission_proto_rawDesc = string([]byte{
	...
	0x74, 0x6f, 0x12, 0x08, 0x74, 0x75, 0x74, 0x6f, 0x72, 0x69, 0x61, 0x6c, 0x22, 0x4c, 0x0a, 0x0f,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12,
	...
	0x03, 0x52, 0x07, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x49, 0x64, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69,
...
var file_permission_proto_goTypes = []any{
	(*EventPermission)(nil), // 0: tutorial.EventPermission
}
